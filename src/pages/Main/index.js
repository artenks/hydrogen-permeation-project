      ...
      <Container>
        ...
        <InformationList>
          <Information>
            ...
            <span>
              Utilize filtros para facilmente encontrar conteúdo e resultados
              que sejam úteis à sua pesquisa.
            </span>
          </Information>
          <Information>
            ...
            <span>
              Visualize gráficos que irão ajudar a comparar seus resultados com
              a literatura.
            </span>
          </Information>
          <Information>
            ...
            <span>
              Com ferramentas de fácil ajuste você ajusta os resultados
              exibidos.
            </span>
          </Information>
        </InformationList>
        ...
        <ParagraphContainer>
          ...
          <Paragraph>
            ...
            parâmetros obtidos em seus experimentos, bastando para isso fazer
            uso da calculadaroda de difusão, que é empregada de acordo com a
            metodologia de teste de permeação por hidrogênio empregado:
            duplo-potenciostática, galvanostática-potenciostática, ou em
        ...
        <ParagraphContainer>
          ...
          <Paragraph>
            ...
            (angstrons) o qual comparado com o diâmetro de outros átomos
            metálicos é muito menor. Esta característica dá ao hidrogênio
            significante mobilidade (difusão) em metais (MAMANI, 2005).
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            Aços de alta resistência mecânica são particularmente susceptíveis
            ao fenômeno de fragilização devido às pressões internas que podem
            surgir no interior do material devido à recombinação do hidrogênio
            molecular durante serviço. Esta susceptibilidade pode ser elevada
            com o aumento do limite de resistência do material, o que tem
            exigido estudos de caracterização deste efeito em condições
            operacionais mais severas.
          </Paragraph>
          <Paragraph>
            Considerando o efeito do hidrogênio nos materiais metálicos,
            torna-se necessário a realização de experimentos no intuito da
            determinação de parâmetros relacionados à difusão como Difusividade,
            Permeabilidade e Solubilidade (VELASCO 2007 apud OLIVEIRA et al.,
            2015).
          </Paragraph>
          <Paragraph>
            ...
            que é formada por duas células adjacentes denominadas célula de
            carga e célula de detecção.
          </Paragraph>
          <Paragraph>
            Considerando as mais diversas variáveis que podem afetar o fenômeno
            de difusão do hidrogênio em materiais metálicos, órgãos
            internacionais como American Society for Testing and Materials
            (ASTM), bem como International Organization for Standardization
            (ISO), formularam normas que buscam padronizar os procedimentos
            metodológicos em relação à determinação experimental dos parâmetros
            de difusão citados acima.
          </Paragraph>
          <Paragraph>
            ...
            que as equações propostas por ASTM e ISO não serem suficientes para
            se analisar o problema em sua plenitude e contribuírem para as
          ...
          <Paragraph>
            ...
            faces da membrana metálica situada na célula eletroquímica de carga
            e medir seu fluxo de permeação através da membrana pela oxidação
            eletroquímica na célula adjacente conhecida como célula de detecção.
            Portanto, a intensidade de corrente de oxidação do hidrogênio
            atômico é uma medida direta do fluxo de permeação de hidrogênio
            através da membrana metálica. A célula de permeação (Figura 8),
            constituída das células de carga e detecção, é denominada muitas
            vezes de célula gêmea (twin cell). Como pode ser observado, as
            células situam-se simetricamente sendo divididas pela a membrana
            metálica que se encontra localizada no centro.
          </Paragraph>
          ...
          <Paragraph>
            ...
            através do metal até a outra superfície da membrana metálica, onde
            se aplica uma polarização anódica com a finalidade de oxidá-lo (H →
            H+ + e-) mantendo sua concentração praticamente próxima de zero
            nesta superfície. Essa intensidade de corrente de oxidação é
            proporcional ao fluxo de massa de hidrogênio que atravessa o metal
            (Velasco, 2007).
          </Paragraph>
          <Paragraph>
            Estando o lado de geração mantido em potencial constante denomina-se
            a técnica com sendo duplo-potenciostática. Em 1976 Boes & Züchner
          ...
          <Paragraph>
            ...
            duplo-potenciostática a condição de contorno na célula de produção
            de hidrogênio assegura uma concentração constante de hidrogênio
            enquanto que no método galvanostático-potenciostático a célula de
            carga assegura um fluxo ou produção constante de hidrogênio. Na
            prática, o primeiro método pode ser comprometido devido à aderência
            de bolhas de hidrogênio coalescidas, aumentando a área de cobertura
            deste gás na superfície do metal. No segundo, devido à produção de
            hidrogênio por unidade de área se manter sempre constante, a
            condição de contorno é assegurada muito mais eficientemente.
          </Paragraph>
          ...
          <Observation>
            * Onde C é a concentração de hidrogênio, x a distância e t é o
            tempo.
          </Observation>
          ...
          <Paragraph>
            ...
            superfície de saída é mantida sob uma concentração zero de
            hidrogênio, as condições de contorno são (Boes & Züchner, 1976):
          </Paragraph>
          ...
          <Paragraph>
            ...
            (duplo-potenciostático) na superfície de carregamento, as condições
            de contorno são:
          </Paragraph>
          ...
          <Paragraph>
            A variação no fluxo de permeação através da superfície em x=L é
            obtida através da primeira lei de Fick (Abdul-Hamid, 1993):
          </Paragraph>
          ...
          <Paragraph>
            ...
            estado-estacionário de permeação é atingido. Se nenhuma perda no
            fluxo (devido a aprisionamento ou reações superficiais) ocorre, o
            fluxo de carga é esperado ser igual ao fluxo de estado-estacionário
          ...
          <Paragraph>
            Igualmente, combinando as equações (15) e a primeira lei de Fick
            (16), tem-se:
          </Paragraph>
          ...
          <Paragraph>
            ...
            permeação eletroquímica, o coeficiente de difusão pode ser
            encontrado. Tais tempos incluem o break-through time, tb, e o time
            lag, tL.
          </Paragraph>
          ...
          <Paragraph>
            ...
            foi estabelecido na membrana. A interceptação sobre o eixo do tempo
            da extrapolação da linha reta dá o chamado time lag, tL (Boes &
            Züchner, 1976).
          </Paragraph>
          ...
          <Paragraph>
            ...
            aumentada na ordem de perlita degenerada, bainita e ferrita
            acicular, ou seja apresentaram maiores valores de solubilidade,
            consequentemente a microestrutura afeta os resultados obtidos em
            testes de permeação eletroquímica de hidrogênio.
          </Paragraph>

          <Paragraph>
            Serna et al. (2005) estudaram dois aços catalogados pela API como
            X52. Um apresentava uma microestrutura composta de finos grãos de
            ferrita equaxial com pequenas quantidades de outros constituintes,
            tal como perlita. O outro era composto de finos grãos de ferrita
            acicular com perlita preferencialmente distribuída em contornos de
            grão. Eles concluíram que os principais parâmetros que controlam a
            difusividade e o aprisionamento em aços microligados de resistência
            similar são: a densidade de discordâncias e a forma com quais os
            precipitados estão distribuídos dentro do aço.
          </Paragraph>

          <Paragraph>
            Estudando o aço AISI 430 Yen & Huang (2003) mostraram que o aumento
            na densidade de discordância, como resultado de trabalho a frio, foi
            responsável pela diminuição na difusividade de hidrogênio e aumento
            na solubilidade.
          </Paragraph>

          <Paragraph>
            Dietzel et al. (2006) mostraram que testes de permeação realizados
            em amostras obtidas a partir de chapa de aço ferrítico FeE960T
          ...
          <Paragraph>
            ...
            interação do hidrogênio com o metal. Pequenas variações podem
            aumentar ou diminuir de forma considerável a difusividade e a
            permeabilidade. Geralmente, na literatura propõe-se que essas
            propriedades obedecem à relação de Arrhenius (Hirt, 1980).
          </Paragraph>

          <Paragraph>
            Au (2007) e Addach et al. (2005) mostraram a eficiência do aumento
            da temperatura para se introduzir altos níveis de hidrogênio nos
          ...
          <Paragraph>
            ...
            substancial na cinética de entrada de hidrogênio para o ferro e
            ligas ferrosas (Morris, 1998). Esses elementos adicionais são
            conhecidos como envenenadores (Schowen et al, 2007).
          </Paragraph>

          <Paragraph>
            Mamani et al. (2007) estudou o uso de envenenadores em Permeação
            eletroquímica de hidrogênio em Armco-Fe. Ele mostrou que
            envenenadores a base de As apresentaram melhor eficiência para
            promover a permeação de hidrogênio.
          </Paragraph>
        </ParagraphContainer>
      </Container>
    </Scrollbar>
